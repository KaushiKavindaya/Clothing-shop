            ...
            <div className='container flex justify-between items-center'>
                <div>
                    <a href="#" className='font-bold text-2xl sm:text-3xl flex gap-2'>
                        <img src={Logo} alt="Logo" className='w-20 uppercase'></img>Spring & Summer
                    </a>
                </div>
                ...
                <div className='flex justify-between items-center gap-4'>
                    ...
                    <div className='relative group hidden sm:block'>
                        <input type="text" placeholder="Search for products" className='w-[200px] sm:w-[200px] 
                        group-hover:w-[300px] transition-all duration-300 rounded-full border border-gray-300 px-2 py-1 
                        focus:outline-none focus:border-1 focus:border-primary dark:border-gray-500 dark:bg-gray-800'/>
                        <IoMdSearch className='text-gray-500 group-hover:text-primary absolute top-1/2 -translate-y-1/2 right-3' />
                    </div>

                    { /* Order Button*/}
                    <button onClick={() => alert("Ordering not available yet!")} className='bg-gradient-to-r from-primary
        ...
        <div className='flex justify-center'>
            <ul className='sm:flex hidden items-center gap-4'>
                ...
                <li className='group relative cursor-pointer'>
                    ...
                    <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 
